...
- <p style='text-align: justify;'> <b>Dataset 1</b> is based on the ATLAS GEANT4 open datasets <a href="http://opendata-qa.cern.ch/record/15012">link</a>. There are two groups of datasets, one for photons and one for charged pions. Each set consists of 15 energies from 256 MeV up to 4TeV produced in powers of two. Each dataset contains the voxelised shower information (368 for photons and 533 for pions) obtained from single particles  produced at the calorimeter surface in the &eta; range (0.2-0.25) and simulated in the ATLAS detector. 10k events are available in each sample with the exception of those at higher energies that have a lower statistics. These samples were used to train the corresponding two GANs presented in the AtlFast3 paper <a href="https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/SIMU-2018-04/">SIMU-2018-04</a> and in the FastCaloGAN note <a href="https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PUBNOTES/ATL-SOFT-PUB-2020-006/">ATL-SOFT-PUB-2020-006</a>.</p>
